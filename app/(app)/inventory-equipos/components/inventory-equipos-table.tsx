  ...
  const handlePrintLabels = () => {
    if (filteredAndSortedEquipos.length === 0) {
        toast({
            ...
            description: "No hay equipos visibles para imprimir.",
        });
        return;
    }
    ...
    const itemsHtml = filteredAndSortedEquipos.map(equipo => `
        <div class="label-page">
            <div class="qr-container">
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${equipo.id}" />
            </div>
            <div class="info-container">
                <div class="inv-num">${equipo.serial || 'S/N'}</div>
      ...
      <div className="p-4 border-b flex flex-wrap items-center gap-4">
         <Input 
          ...
          <div className="ml-auto flex items-center gap-2">
            <Button variant="outline" onClick={handlePrintLabels} disabled={loading || filteredAndSortedEquipos.length === 0}>
