...
import { PlusCircle, Loader2, CalendarIcon, Check, Clock } from 'lucide-react';
...
interface AddGanttTaskDialogProps {}
...
export function AddGanttTaskDialog({}: AddGanttTaskDialogProps) {
  ...
  async function onSubmit(data: GanttTaskFormValues) {
    ...
    try {
        ...
        toast({
            title: '¡Tarea de Gantt añadida!',
            description: `La tarea "${data['nombre tarea']}" se ha añadido a la base de datos.`,
        });
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        <Button>
          ...
          Añadir Tarea a Gantt
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-xl">
        <DialogHeader>
          <DialogTitle>Crear Nueva Tarea para Gantt</DialogTitle>
          <DialogDescription>
            Ingresa los detalles de la nueva tarea de planificación a largo plazo.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
          <form
